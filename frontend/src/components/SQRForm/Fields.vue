  ...
  <v-col :style="{ minWidth: '100%' }">
    <v-row>
      <v-col class="my-2" cols="12">
        ...
        <guidelines>
          <p>
            ...
            selecting one of the options: Good, Average, Bad, Entire file is
            Inaudible, Entire file is Blank. The basis of rating will be the
            audibility of Srila Gurudeva’s voice. In other words, if you find it
            difficult or strenuous to understand what Srila Gurudeva is
            speaking, due to too much background noise or volume being too low
            and so on, please choose ‘Bad’. On the other hand, if the audio is
            clear, with no background noise and good volume, please choose
            ‘Good.’ In cases where you can hear Srila Gurudeva well but there is
            some sound issue also, choose ‘Average’. This will help us decide
            which SE to allot the file to.
          </p>
        </guidelines>
      </v-col>
      ...
      <v-col class="my-2" cols="12">
        ...
        ></unwanted-parts>
        <guidelines>
          For each unwanted part you identify, please fill details in one such
          block.
          ...
          <ul>
            ...
            <li>
              For e.g. If from 20 minutes and 10 seconds to 21 minutes and 20
              seconds there is an abrupt blank space, please write 20:10 in the
              ‘Beginning field’ and 21:20 in the Ending field. Choose ‘Blank
      ...
      <v-col class="my-2" cols="12">
        ...
        ></sound-issues>
        <guidelines>
          For every issue you wish to report for the SE’s attention, please fill
          this part as follows.

          <ul>
            <li>
              Enter the Beginning and Ending timing of the section in (h:)mm:ss
            ...
            <li>
              ...
              is speaking, then please write ‘20:20’ in the Beginning field and
              ‘21:34’ in the Ending field. Choose the option ‘Background noise’
      ...
      <v-col class="my-2" cols="12">
        ...
        <guidelines>
          <ul>
            <li>
              Is there any issue with the overall sound quality? E.g. Background
